...
#define UI_SHOW_WINDOW(...) do { }while(0)
#define UI_HIDE_WINDOW(...) do { }while(0)
#define UI_GET_WINDOW_ID()  0
#define UI_HIDE_CURR_WINDOW()   do { }while(0)
#define UI_SHOW_MENU(...)   do { }while(0)
#define UI_MSG_POST(...)    do { }while(0)
#define UI_REFLASH_WINDOW(a)    do { }while(0)
#define UI_MOTO_RUN(...)    do { }while(0)

#define UI_WINDOW_BACK_PUSH(a)  do { }while(0)
#define UI_WINDOW_BACK_SHOW(a)  do { }while(0)
#define UI_WINDOW_BACK_SPEC_SHOW(a) do { }while(0)
#define UI_WINDOW_BACK_CLEAN()  do { }while(0)
#define UI_WINDOW_BACK_SUB()    do { }while(0)
#define UI_WINDOW_BACK_INDEX()  do { }while(0)
#define UI_WINDOW_BACK_DEL(a)   do { }while(0)

#define UI_WINDOW_PREEMPTION_POSH(a,b,c,d)  0
#define UI_WINDOW_PREEMPTION_DEL(a) do { }while(0)
#define UI_WINDOW_PREEMPTION_POP(a) do { }while(0)
