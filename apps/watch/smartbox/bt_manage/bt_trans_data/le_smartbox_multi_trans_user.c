...
#include "le_smartbox_multi_trans_user.h"

#if ((TCFG_BLE_DEMO_SELECT == DEF_BLE_DEMO_TRANS_DATA) && SMBOX_MULTI_BLE_SLAVE_NUMS && SMBOX_MULTI_BLE_EN && (SMBOX_MULTI_SEL_FUNC == SLAVE_CONN_USER))
