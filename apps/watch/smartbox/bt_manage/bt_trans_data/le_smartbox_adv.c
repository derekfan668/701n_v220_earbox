...
#if (TCFG_BLE_DEMO_SELECT == DEF_BLE_DEMO_RCSP_DEMO || (SMBOX_MULTI_SEL_FUNC == SLAVE_CONN_JLAPP))
...
int smartbox_make_set_adv_data(void)
{
    ...
    u8 *buf = adv_data;
    static const u8 wuxin_uuid_16bit[] = {0xE7, 0xFE};
    ...
    offset += make_eir_packet_data(&buf[offset], offset, HCI_EIR_DATATYPE_COMPLETE_16BIT_SERVICE_UUIDS, (void *)wuxin_uuid_16bit, 2);
#endif
