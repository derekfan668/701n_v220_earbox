...
static void app_common_device_event_handler(struct sys_event *event)
{
    ...
    case DEVICE_EVENT_FROM_U2A:
        extern void upay2ali_event_handler(struct sys_event * e);
        upay2ali_event_handler(event);
        break;

    case DEVICE_EVENT_FROM_A2U:
        extern void ali2upay_event_handler(struct sys_event * e);
        ali2upay_event_handler(event);
        break;
#endif //TCFG_PAY_ALIPAY_ENABLE
    ...
    case DEVICE_EVENT_FROM_POWER:
        ...
        break;
#if PC_AUDIO_EMITTER
    case DEVICE_EVENT_FROM_LOP:
        extern void local_play_event_handler(struct sys_event *e);
        local_play_event_handler(event);
        break;
