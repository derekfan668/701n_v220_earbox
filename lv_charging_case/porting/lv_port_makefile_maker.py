...
path_porting = r'lv_charging_case/porting/'
...
# 将输出保存到txt文件
output_file_path = "lv_port.mk"
with open(output_file_path, "w") as output_file:
    output_file.write("LV_PORT_SRC = \\ \n")
    for c_file in c_files:
        output_file.write("\t" + path_porting + c_file + " \\" + "\n")

    output_file.write("\n")

    output_file.write("LV_PORT_INC = \\ \n")
    for directory_with_h_file in directories_with_h_files:
        output_file.write("\t" + "-I" + path_porting + directory_with_h_file +  " \\" + "\n")
