...
static void screen_alarm_ring_deinit()
{
	...
	if(lv_obj_is_valid(guider_ui.screen_alarm_ring_animimg_ring_bg)) {
...
{
	//判断页面存活
	if(!lv_obj_is_valid(guider_ui.screen_alarm_ring)){return;}
	// printf("%s\n", __FUNCTION__);
	...
	switch (language) {
		case CHINESE:
			lv_imgbtn_set_src(guider_ui.screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_RELEASED, NULL, "F:/ic_tingzhi.bin", NULL);
			lv_imgbtn_set_src(guider_ui.screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_DISABLED, NULL, "F:/ic_tingzhi.bin", NULL);
			lv_imgbtn_set_src(guider_ui.screen_alarm_ring_imgbtn_alarm_repeat, LV_IMGBTN_STATE_RELEASED, NULL, "F:/ic_chongfu.bin", NULL);
			lv_imgbtn_set_src(guider_ui.screen_alarm_ring_imgbtn_alarm_repeat, LV_IMGBTN_STATE_DISABLED, NULL, "F:/ic_chongfu.bin", NULL);
			break;
		case ENGLISH:
			lv_imgbtn_set_src(guider_ui.screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_RELEASED, NULL, "F:/ic_tingzhi_eng.bin", NULL);
			lv_imgbtn_set_src(guider_ui.screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_DISABLED, NULL, "F:/ic_tingzhi_eng.bin", NULL);
			lv_imgbtn_set_src(guider_ui.screen_alarm_ring_imgbtn_alarm_repeat, LV_IMGBTN_STATE_RELEASED, NULL, "F:/ic_chongfu_eng.bin", NULL);
			lv_imgbtn_set_src(guider_ui.screen_alarm_ring_imgbtn_alarm_repeat, LV_IMGBTN_STATE_DISABLED, NULL, "F:/ic_chongfu_eng.bin", NULL);
			break;
		default:
			break;
	}
