...
// 取消查找耳机
static void screen_findmy_img_findmy_cancel_event_handler (lv_event_t *e)
{
	lv_event_code_t code = lv_event_get_code(e);
...
// 开始查找耳机
static void screen_findmy_img_findmy_start_event_handler (lv_event_t *e)
{
	lv_event_code_t code = lv_event_get_code(e);
...
void events_init_screen_findmy(lv_ui *ui)
{
	...
	lv_obj_add_event_cb(ui->screen_findmy_img_findmy_cancel, screen_findmy_img_findmy_cancel_event_handler, LV_EVENT_ALL, NULL);
	lv_obj_add_event_cb(ui->screen_findmy_img_findmy_start, screen_findmy_img_findmy_start_event_handler, LV_EVENT_ALL, NULL);
}
...
void screen_findmy_refresh()
{
	...
	switch (language) {
		case CHINESE:
			...
			lv_img_set_src(guider_ui.screen_findmy_img_findmy_cancel, "F:/ic_quxiao_chazhaoerji.bin");
			lv_img_set_src(guider_ui.screen_findmy_img_findmy_start, "F:/ic_kaishi_chazhaoerji.bin");
			break;
		case ENGLISH:
			...
			lv_img_set_src(guider_ui.screen_findmy_img_findmy_cancel, "F:/ic_quxiao_chazhaoerji_eng.bin");
			lv_img_set_src(guider_ui.screen_findmy_img_findmy_start, "F:/ic_kaishi_chazhaoerji_eng.bin");
			break;
		default:
			break;
	}
