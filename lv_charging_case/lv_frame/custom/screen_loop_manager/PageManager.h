...
#define PageLimit       (20) // 20
// 页面切换速度
#define AnimMoveSpeed   800 // 如果希望滑动页面快速完成可以尝试改为2000
// 页面切换动画模式
#define AnimMoveMode    lv_anim_path_ease_out // lv_anim_path_ease_in_out

// 惯性触发页面滑动
#define EnergyTrigger   0

#if EnergyTrigger
// 惯性判断时长，用于区分快速拖动和慢速拖动
#define EnergyTime      100

#undef AnimMoveSpeed
#define AnimMoveSpeed   2000
...
struct PM_Custom_Fun {
    void (*status_bar_bottom_update)(enum Page_Id id); // 底部状态栏更新
