...
void lv_upadate_status_bar_bottom_by_id(enum Page_Id id)
{
    if (lv_obj_is_valid(status_bar_bottom.img_slider_bottom)) {
        switch (id) {
...
{
    if(lv_obj_is_valid(status_bar_bottom.cont)) {
