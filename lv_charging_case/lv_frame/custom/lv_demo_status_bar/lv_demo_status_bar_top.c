...
void lv_status_bar_top_init(lv_obj_t *page)
{
	...
	lv_label_set_text(status_bar_top.label_battery_left, "100%");
	...
	lv_label_set_text(status_bar_top.label_battery_right, "100%");
	...
	lv_label_set_text(status_bar_top.label_battery_box, "100%");
...
{
	if(lv_obj_is_valid(status_bar_top.cont)) {
