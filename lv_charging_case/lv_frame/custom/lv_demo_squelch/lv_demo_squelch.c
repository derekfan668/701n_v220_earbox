...
static void screen_squelch_img_sq_start_event_handler (lv_event_t *e)
{
...
static void screen_squelch_img_sq_ing_cancel_event_handler (lv_event_t *e)
{
	lv_event_code_t code = lv_event_get_code(e);
...
{
	lv_obj_add_event_cb(ui->screen_squelch_img_sq_start, screen_squelch_img_sq_start_event_handler, LV_EVENT_ALL, NULL);
	lv_obj_add_event_cb(ui->screen_squelch_img_sq_ing_cancel, screen_squelch_img_sq_ing_cancel_event_handler, LV_EVENT_ALL, NULL);
}
...
void screen_squelch_refresh()
{
	...
	switch (language) {
		case CHINESE:
            ...
            lv_img_set_src(guider_ui.screen_squelch_img_sq_start, "F:/ic_kaishi.bin");
            lv_img_set_src(guider_ui.screen_squelch_img_sq_ing_cancel, "F:/ic_quxiao.bin");
			break;
		case ENGLISH:
            lv_img_set_src(guider_ui.screen_squelch_img_sq_start, "F:/ic_kaishi_eng.bin");
            lv_img_set_src(guider_ui.screen_squelch_img_sq_ing_cancel, "F:/ic_quxiao_eng.bin");
	...
	if(contorl_enable){
        lv_obj_clear_state(guider_ui.screen_squelch_img_sq_start, LV_STATE_DISABLED);
	}else{
        lv_obj_add_state(guider_ui.screen_squelch_img_sq_start, LV_STATE_DISABLED);
	}
