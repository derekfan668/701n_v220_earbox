...
void setup_scr_screen_product_test(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_obj_set_size(ui->screen_product_test_btn_screen, 96, 83);
	...
	lv_obj_set_style_text_font(ui->screen_product_test_btn_screen, &lv_font_simsun_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_size(ui->screen_product_test_btn_tp, 96, 83);
	...
	lv_obj_set_style_text_font(ui->screen_product_test_btn_tp, &lv_font_simsun_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_size(ui->screen_product_test_btn_connect, 96, 83);
	...
	lv_obj_set_style_text_font(ui->screen_product_test_btn_connect, &lv_font_simsun_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_product_test_btn_reset, &lv_font_simsun_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_product_test_btn_pc, &lv_font_simsun_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_product_test_btn_storage_mode, &lv_font_simsun_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_product_test_btnm_tp_test, &lv_font_montserratMedium_16, LV_PART_ITEMS|LV_STATE_DEFAULT);
