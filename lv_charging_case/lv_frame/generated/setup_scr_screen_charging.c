...
void setup_scr_screen_charging(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_obj_clear_flag(ui->screen_charging_cont_charging, LV_OBJ_FLAG_SCROLLABLE);	//充电界面-禁止触摸滑动
	...
	lv_obj_set_style_text_font(ui->screen_charging_label_charging, &lv_font_simsun_24, LV_PART_MAIN|LV_STATE_DEFAULT);
