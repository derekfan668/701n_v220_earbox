...
typedef struct
{
	...
	lv_obj_t *screen_alarm_img_alarm_cancel;
	...
	lv_obj_t *screen_squelch_img_sq_start;
	...
	lv_obj_t *screen_squelch_img_sq_ing_cancel;
	...
	lv_obj_t *screen_findmy_img_findmy_cancel;
	lv_obj_t *screen_findmy_img_findmy_start;
	...
	lv_obj_t *screen_light_img_light_on;
...
LV_IMG_DECLARE(screen_charging_animimg_chargingcharging_00);
...
LV_FONT_DECLARE(lv_font_pingfangheiti_bold_24)
LV_FONT_DECLARE(lv_font_simsun_24)
LV_FONT_DECLARE(lv_font_simsun_16)
LV_FONT_DECLARE(lv_font_pingfangheiti_bold_56)
