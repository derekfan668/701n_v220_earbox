...
void setup_scr_screen_tiktok(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_obj_set_pos(ui->screen_tiktok_label_tiktok_like, 111, 30);
	lv_obj_set_size(ui->screen_tiktok_label_tiktok_like, 100, 32);
	...
	lv_obj_set_style_text_font(ui->screen_tiktok_label_tiktok_like, &lv_font_pingfangheiti_bold_16, LV_PART_MAIN|LV_STATE_DEFAULT);
