...
void setup_scr_screen_brightness(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_label_set_long_mode(ui->screen_brightness_label_bn_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_brightness_label_bn_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
