...
void setup_scr_screen_equalizer(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_label_set_long_mode(ui->screen_equalizer_label_eq_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_equalizer_label_eq_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_equalizer_label_eq_mode, &lv_font_pingfangheiti_bold_32, LV_PART_MAIN|LV_STATE_DEFAULT);
