...
void setup_scr_screen_findmy(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_obj_set_style_text_font(ui->screen_findmy_imgbtn_findmy_left, &lv_font_simsun_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_findmy_imgbtn_findmy_left, &lv_font_simsun_12, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->screen_findmy_imgbtn_findmy_left, &lv_font_simsun_12, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_label_set_long_mode(ui->screen_findmy_label_findmy_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_findmy_label_findmy_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_findmy_imgbtn_findmy_right, &lv_font_simsun_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_findmy_imgbtn_findmy_right, &lv_font_simsun_12, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->screen_findmy_imgbtn_findmy_right, &lv_font_simsun_12, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	//Write codes screen_findmy_img_findmy_cancel
	ui->screen_findmy_img_findmy_cancel = lv_img_create(ui->screen_findmy_cont_findmy_confirm);
	lv_obj_add_flag(ui->screen_findmy_img_findmy_cancel, LV_OBJ_FLAG_CLICKABLE);
#if LV_USE_GUIDER_SIMULATOR
	lv_img_set_src(ui->screen_findmy_img_findmy_cancel, "F:\\charging_case_sdk\\charging_case_ui\\gui_guider_ui\\earphone_flash\\earphone\\import\\image\\ic_quxiao_chazhaoerji.png");
#else
	lv_img_set_src(ui->screen_findmy_img_findmy_cancel, "F:/ic_quxiao_chazhaoerji.bin");
#endif
	lv_img_set_pivot(ui->screen_findmy_img_findmy_cancel, 50,50);
	lv_img_set_angle(ui->screen_findmy_img_findmy_cancel, 0);
	lv_obj_set_pos(ui->screen_findmy_img_findmy_cancel, 46, 100);
	lv_obj_set_size(ui->screen_findmy_img_findmy_cancel, 82, 36);

	//Write style for screen_findmy_img_findmy_cancel, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_opa(ui->screen_findmy_img_findmy_cancel, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes screen_findmy_img_findmy_start
	ui->screen_findmy_img_findmy_start = lv_img_create(ui->screen_findmy_cont_findmy_confirm);
	lv_obj_add_flag(ui->screen_findmy_img_findmy_start, LV_OBJ_FLAG_CLICKABLE);
#if LV_USE_GUIDER_SIMULATOR
	lv_img_set_src(ui->screen_findmy_img_findmy_start, "F:\\charging_case_sdk\\charging_case_ui\\gui_guider_ui\\earphone_flash\\earphone\\import\\image\\ic_kaishi_chazhaoerji.png");
#else
	lv_img_set_src(ui->screen_findmy_img_findmy_start, "F:/ic_kaishi_chazhaoerji.bin");
#endif
	lv_img_set_pivot(ui->screen_findmy_img_findmy_start, 50,50);
	lv_img_set_angle(ui->screen_findmy_img_findmy_start, 0);
	lv_obj_set_pos(ui->screen_findmy_img_findmy_start, 190, 100);
	lv_obj_set_size(ui->screen_findmy_img_findmy_start, 82, 36);

	//Write style for screen_findmy_img_findmy_start, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_opa(ui->screen_findmy_img_findmy_start, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_long_mode(ui->screen_findmy_label_findmy_confirm_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_findmy_label_findmy_confirm_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
