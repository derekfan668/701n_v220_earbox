...
void setup_scr_screen_alarm_ring(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_repeat, LV_IMGBTN_STATE_RELEASED, NULL, "F:\\charging_case_sdk\\ui\\charging_case_ui\\earphone_flash\\earphone\\import\\image\\ic_chongfu.png", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_repeat, LV_IMGBTN_STATE_PRESSED, NULL, "F:\\charging_case_sdk\\ui\\charging_case_ui\\earphone_flash\\earphone\\import\\image\\ic_chongfu.png", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_repeat, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "F:\\charging_case_sdk\\ui\\charging_case_ui\\earphone_flash\\earphone\\import\\image\\ic_chongfu.png", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_repeat, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "F:\\charging_case_sdk\\ui\\charging_case_ui\\earphone_flash\\earphone\\import\\image\\ic_chongfu.png", NULL);
#else
	...
	lv_label_set_text(ui->screen_alarm_ring_imgbtn_alarm_repeat_label, "");
	...
	lv_obj_set_style_text_color(ui->screen_alarm_ring_imgbtn_alarm_repeat, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_alarm_ring_imgbtn_alarm_repeat, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_alarm_ring_imgbtn_alarm_repeat, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_alarm_ring_imgbtn_alarm_repeat, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_alarm_ring_imgbtn_alarm_repeat, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_alarm_ring_imgbtn_alarm_repeat, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_CHECKED);
...
#if LV_USE_GUIDER_SIMULATOR
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_RELEASED, NULL, "F:\\charging_case_sdk\\ui\\charging_case_ui\\earphone_flash\\earphone\\import\\image\\ic_tingzhi.png", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_PRESSED, NULL, "F:\\charging_case_sdk\\ui\\charging_case_ui\\earphone_flash\\earphone\\import\\image\\ic_tingzhi.png", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "F:\\charging_case_sdk\\ui\\charging_case_ui\\earphone_flash\\earphone\\import\\image\\ic_tingzhi.png", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "F:\\charging_case_sdk\\ui\\charging_case_ui\\earphone_flash\\earphone\\import\\image\\ic_tingzhi.png", NULL);
#else
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_RELEASED, NULL, "F:/ic_tingzhi.bin", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_PRESSED, NULL, "F:/ic_tingzhi.bin", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "F:/ic_tingzhi.bin", NULL);
	lv_imgbtn_set_src(ui->screen_alarm_ring_imgbtn_alarm_stop, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "F:/ic_tingzhi.bin", NULL);
#endif
	ui->screen_alarm_ring_imgbtn_alarm_stop_label = lv_label_create(ui->screen_alarm_ring_imgbtn_alarm_stop);
	lv_label_set_text(ui->screen_alarm_ring_imgbtn_alarm_stop_label, "");
	...
	lv_obj_set_style_text_color(ui->screen_alarm_ring_imgbtn_alarm_stop, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_alarm_ring_imgbtn_alarm_stop, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_alarm_ring_imgbtn_alarm_stop, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_alarm_ring_imgbtn_alarm_stop, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_alarm_ring_imgbtn_alarm_stop, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_alarm_ring_imgbtn_alarm_stop, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_CHECKED);
