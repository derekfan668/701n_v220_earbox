...
#ifndef LV_CUSTOMER_FONT_MONTSERRATMEDIUM_32
#define LV_CUSTOMER_FONT_MONTSERRATMEDIUM_32 1
#endif

#if LV_CUSTOMER_FONT_MONTSERRATMEDIUM_32
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1936, .adv_w = 306, .box_w = 16, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2072, .adv_w = 349, .box_w = 19, .box_h = 24, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2300, .adv_w = 292, .box_w = 17, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2445, .adv_w = 349, .box_w = 18, .box_h = 24, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2661, .adv_w = 313, .box_w = 18, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2814, .adv_w = 181, .box_w = 13, .box_h = 24, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2970, .adv_w = 353, .box_w = 19, .box_h = 23, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 3189, .adv_w = 349, .box_w = 18, .box_h = 24, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3405, .adv_w = 143, .box_w = 5, .box_h = 24, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3465, .adv_w = 145, .box_w = 10, .box_h = 30, .ofs_x = -3, .ofs_y = -6},
    {.bitmap_index = 3615, .adv_w = 315, .box_w = 18, .box_h = 24, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3831, .adv_w = 143, .box_w = 4, .box_h = 24, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3879, .adv_w = 541, .box_w = 30, .box_h = 17, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4134, .adv_w = 349, .box_w = 18, .box_h = 17, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4287, .adv_w = 325, .box_w = 18, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4440, .adv_w = 349, .box_w = 19, .box_h = 23, .ofs_x = 2, .ofs_y = -6},
    {.bitmap_index = 4659, .adv_w = 349, .box_w = 18, .box_h = 23, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 4866, .adv_w = 210, .box_w = 11, .box_h = 17, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4960, .adv_w = 257, .box_w = 16, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5096, .adv_w = 212, .box_w = 13, .box_h = 21, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5233, .adv_w = 347, .box_w = 17, .box_h = 17, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5378, .adv_w = 286, .box_w = 19, .box_h = 17, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 5540, .adv_w = 460, .box_w = 29, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5787, .adv_w = 283, .box_w = 18, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5940, .adv_w = 286, .box_w = 19, .box_h = 23, .ofs_x = -1, .ofs_y = -6},
    {.bitmap_index = 6159, .adv_w = 267, .box_w = 15, .box_h = 17, .ofs_x = 1, .ofs_y = 0}
};
...
static const uint8_t kern_left_class_mapping[] =
{
    0, 1, 0, 2, 3, 4, 5, 6,
    7, 8, 1, 9, 10, 11, 12, 13,
    14, 15, 9, 15, 15, 16, 12, 9,
    9, 10, 10, 17, 18, 19, 20, 15,
    21, 21, 22, 21, 23
};
...
static const uint8_t kern_right_class_mapping[] =
{
    ...
    0, 12, 11, 13, 14, 11, 11, 13,
    13, 12, 13, 12, 13, 15, 16, 17,
    18, 18, 19, 18, 20
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t lv_customer_font_montserratMedium_32 = {
#else
lv_font_t lv_customer_font_montserratMedium_32 = {
#endif
...
#endif /*#if LV_CUSTOMER_FONT_MONTSERRATMEDIUM_32*/
