...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x0, 0x0, 0x0, 0x2f, 0x80, 0x4, 0x60,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x9, 0xd0, 0x0,
    0xb, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0xf4,
    0x0, 0x0, 0x93, 0x0, 0x0, 0x0, 0x0, 0x0,
    0xaa, 0x0, 0x0, 0x2, 0xd0, 0x0, 0x0, 0x0,
    0x0, 0x3e, 0x10, 0x0, 0x0, 0x9, 0xa0, 0x0,
    0x0, 0x0, 0x1d, 0x30, 0x0, 0x0, 0x0, 0xc,
    0xc1, 0x0, 0x0, 0xb, 0x40, 0x0, 0x0, 0x0,
    0x5, 0x5c, 0xf8, 0x20, 0x9, 0x33, 0x76, 0x6f,
    0x86, 0x66, 0xcb, 0x9, 0xe6, 0x6, 0x0, 0x0,
    0x2, 0xf1, 0x0, 0xb, 0x60, 0x0, 0x0, 0x0,
    ...
    0xf6, 0x0, 0x0, 0x0, 0x5, 0xf2, 0x0, 0x0,
    0x0, 0xf, 0x20, 0x0, 0x0, 0x0, 0x99, 0x0,
    0x55, 0x0, 0x0, 0xf2, 0x0, 0x0, 0x0, 0xe,
    0x76, 0x69, 0x91, 0x0, 0xe, 0x20, 0x1, 0x0,
    0x4, 0xb0, 0x0, 0x0, 0x2c, 0x66, 0xf7, 0x66,
    0xe6, 0x0, 0xb3, 0x0, 0x24, 0x1, 0xe0, 0xe,
    0x20, 0xf, 0x30, 0x2c, 0x6a, 0x79, 0xa1, 0x1e,
    0x0, 0xe2, 0x0, 0xf0, 0x8, 0x0, 0xe2, 0x0,
    0x1, 0xe0, 0xe, 0x20, 0xf, 0x2, 0x20, 0xe,
    0x20, 0x0, 0x1e, 0x0, 0xe2, 0x0, 0xf1, 0x0,
    0x0, 0xe2, 0x4, 0x71, 0xf3, 0x3f, 0x53, 0x3f,
    0x10, 0x58, 0x6f, 0x76, 0x66, 0x3e, 0x22, 0xe4,
    0x22, 0xf1, 0x0, 0x0, 0xe2, 0x0, 0x1, 0x40,
    0xe, 0x20, 0x2, 0x0, 0x0, 0xe, 0x20, 0x2,
    0x0, 0x0, 0xe2, 0x0, 0x0, 0x0, 0x0, 0xe2,
    0x8, 0x40, 0x0, 0xe, 0x20, 0x0, 0x0, 0x0,
    0xe, 0x7c, 0x20, 0x0, 0x0, 0xf2, 0x0, 0x0,
    0x0, 0x2, 0xfd, 0x10, 0x0, 0x0, 0xf, 0x20,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4801, .adv_w = 320, .box_w = 19, .box_h = 19, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 4982, .adv_w = 320, .box_w = 19, .box_h = 20, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 5172, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 5382, .adv_w = 320, .box_w = 20, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5532, .adv_w = 320, .box_w = 20, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5722, .adv_w = 320, .box_w = 20, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5872, .adv_w = 220, .box_w = 14, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5977, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 6187, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 6397, .adv_w = 360, .box_w = 23, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 6616, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 6826, .adv_w = 360, .box_w = 23, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 6999, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 7209, .adv_w = 160, .box_w = 10, .box_h = 16, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7289, .adv_w = 240, .box_w = 15, .box_h = 16, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 7409, .adv_w = 360, .box_w = 23, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 7628, .adv_w = 320, .box_w = 20, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7778, .adv_w = 280, .box_w = 13, .box_h = 19, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 7902, .adv_w = 280, .box_w = 18, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 8091, .adv_w = 280, .box_w = 18, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 8262, .adv_w = 280, .box_w = 18, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 8433, .adv_w = 280, .box_w = 13, .box_h = 19, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 8557, .adv_w = 280, .box_w = 19, .box_h = 19, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 8738, .adv_w = 200, .box_w = 11, .box_h = 19, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 8843, .adv_w = 200, .box_w = 11, .box_h = 19, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 8948, .adv_w = 280, .box_w = 18, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 9119, .adv_w = 280, .box_w = 18, .box_h = 5, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 9164, .adv_w = 360, .box_w = 23, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 9337, .adv_w = 400, .box_w = 26, .box_h = 21, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 9610, .adv_w = 360, .box_w = 24, .box_h = 21, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 9862, .adv_w = 320, .box_w = 20, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 10052, .adv_w = 280, .box_w = 18, .box_h = 11, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 10151, .adv_w = 280, .box_w = 18, .box_h = 11, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 10250, .adv_w = 400, .box_w = 26, .box_h = 16, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 10458, .adv_w = 320, .box_w = 20, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 10608, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 10818, .adv_w = 320, .box_w = 21, .box_h = 21, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 11039, .adv_w = 280, .box_w = 18, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 11210, .adv_w = 280, .box_w = 18, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 11399, .adv_w = 280, .box_w = 18, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 11570, .adv_w = 200, .box_w = 14, .box_h = 21, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 11717, .adv_w = 280, .box_w = 18, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 11906, .adv_w = 280, .box_w = 18, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 12095, .adv_w = 360, .box_w = 23, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 12268, .adv_w = 320, .box_w = 22, .box_h = 21, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 12499, .adv_w = 240, .box_w = 15, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 12657, .adv_w = 400, .box_w = 25, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 12895, .adv_w = 400, .box_w = 25, .box_h = 13, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 13058, .adv_w = 400, .box_w = 25, .box_h = 13, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 13221, .adv_w = 400, .box_w = 25, .box_h = 13, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 13384, .adv_w = 400, .box_w = 25, .box_h = 13, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 13547, .adv_w = 400, .box_w = 25, .box_h = 13, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 13710, .adv_w = 400, .box_w = 26, .box_h = 17, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 13931, .adv_w = 280, .box_w = 16, .box_h = 21, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 14099, .adv_w = 280, .box_w = 18, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 14288, .adv_w = 320, .box_w = 21, .box_h = 21, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 14509, .adv_w = 400, .box_w = 25, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 14697, .adv_w = 240, .box_w = 15, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 14855, .adv_w = 322, .box_w = 21, .box_h = 13, .ofs_x = 0, .ofs_y = 1}
};
...
static const uint16_t unicode_list_2[] = {
    0x0, 0x4299, 0x9dfb, 0x9e02, 0x9e05, 0x9e06, 0x9e07, 0x9e0b,
    0x9e0d, 0x9e0f, 0x9e13, 0x9e16, 0x9e1b, 0x9e20, 0x9e21, 0x9e22,
    0x9e38, 0x9e42, 0x9e45, 0x9e46, 0x9e47, 0x9e4b, 0x9e4c, 0x9e4d,
    0x9e4e, 0x9e61, 0x9e62, 0x9e68, 0x9e6a, 0x9e6b, 0x9e6e, 0x9e71,
    0x9e72, 0x9e73, 0x9e75, 0x9e8d, 0x9e8f, 0x9ebe, 0x9ebf, 0x9ec1,
    0x9ee1, 0x9ee4, 0x9eed, 0x9f16, 0x9f1e, 0x9f55, 0x9fe5, 0xa03a,
    0xa03b, 0xa03c, 0xa03d, 0xa03e, 0xa081, 0xa08d, 0xa0e7, 0xa0fe,
    0xa354, 0xa5bc, 0xa69c
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 20998, .range_length = 42653, .glyph_id_start = 95,
