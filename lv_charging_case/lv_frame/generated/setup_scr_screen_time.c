...
void setup_scr_screen_time(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_obj_set_style_text_font(ui->screen_time_label_time_set, &lv_font_pingfangheiti_bold_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_time_label_HMS, &lv_font_pingfangheiti_bold_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_time_label_YMD_return, &lv_font_pingfangheiti_bold_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_time_label_YMD_save, &lv_font_pingfangheiti_bold_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_time_label_HMS_return, &lv_font_pingfangheiti_bold_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_time_label_HMS_save, &lv_font_pingfangheiti_bold_16, LV_PART_MAIN|LV_STATE_DEFAULT);
