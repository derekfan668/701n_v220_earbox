...
void setup_scr_screen_music(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_label_set_long_mode(ui->screen_music_label_music_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_music_label_music_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_music_label_tip, &lv_font_pingfangheiti_bold_22, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_music_btn_cancel, &lv_font_pingfangheiti_bold_22, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_music_btn_confirm, &lv_font_pingfangheiti_bold_22, LV_PART_MAIN|LV_STATE_DEFAULT);
...
void setup_scr_screen_music_local_music(lv_ui *ui)
{
	...
	lv_obj_add_flag(ui->screen_music_img_music_logo, LV_OBJ_FLAG_CLICKABLE);
#if LV_USE_GUIDER_SIMULATOR
	...
	lv_obj_set_pos(ui->screen_music_img_music_logo, 26, 33);
