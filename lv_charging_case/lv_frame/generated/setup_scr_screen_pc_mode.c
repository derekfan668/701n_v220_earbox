...
void setup_scr_screen_pc_mode(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_obj_set_style_text_font(ui->screen_pc_mode_label_usb_tip, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_pc_mode_label_file_transfer, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
