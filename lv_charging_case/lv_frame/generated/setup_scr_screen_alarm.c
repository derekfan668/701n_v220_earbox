...
void setup_scr_screen_alarm(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_obj_set_style_text_font(ui->screen_alarm_label_alarm_time, &lv_font_pingfangheiti_bold_32, LV_PART_MAIN|LV_STATE_DEFAULT);
...
#if LV_USE_GUIDER_SIMULATOR
	lv_imgbtn_set_src(ui->screen_alarm_imgbtn_alarm_setting, LV_IMGBTN_STATE_RELEASED, NULL, "F:\\charging_case_sdk\\charging_case_ui\\gui_guider_ui\\earphone_flash\\earphone\\import\\image\\ic_dingshishezhi.png", NULL);
#else
	...
	lv_label_set_text(ui->screen_alarm_imgbtn_alarm_setting_label, "");
	...
	lv_obj_set_style_text_color(ui->screen_alarm_imgbtn_alarm_setting, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_alarm_imgbtn_alarm_setting, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_alarm_imgbtn_alarm_setting, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_alarm_imgbtn_alarm_setting, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_alarm_imgbtn_alarm_setting, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_alarm_imgbtn_alarm_setting, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_label_set_long_mode(ui->screen_alarm_label_alarm_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_alarm_label_alarm_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_long_mode(ui->screen_alarm_label_alarm_count_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_alarm_label_alarm_count_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write codes screen_alarm_img_alarm_cancel
	ui->screen_alarm_img_alarm_cancel = lv_img_create(ui->screen_alarm_cont_alarm_count);
	lv_obj_add_flag(ui->screen_alarm_img_alarm_cancel, LV_OBJ_FLAG_CLICKABLE);
#if LV_USE_GUIDER_SIMULATOR
	lv_img_set_src(ui->screen_alarm_img_alarm_cancel, "F:\\charging_case_sdk\\charging_case_ui\\gui_guider_ui\\earphone_flash\\earphone\\import\\image\\ic_quxiao_chazhaoerji.png");
#else
	lv_img_set_src(ui->screen_alarm_img_alarm_cancel, "F:/ic_quxiao_chazhaoerji.bin");
#endif
	lv_img_set_pivot(ui->screen_alarm_img_alarm_cancel, 50,50);
	lv_img_set_angle(ui->screen_alarm_img_alarm_cancel, 0);
	lv_obj_set_pos(ui->screen_alarm_img_alarm_cancel, 121, 112);
	lv_obj_set_size(ui->screen_alarm_img_alarm_cancel, 82, 36);

	//Write style for screen_alarm_img_alarm_cancel, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_opa(ui->screen_alarm_img_alarm_cancel, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_alarm_label_alarm_count, &lv_font_montserratMedium_24, LV_PART_MAIN|LV_STATE_DEFAULT);
