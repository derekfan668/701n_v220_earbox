...
void setup_scr_screen_anc(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_label_set_text(ui->screen_anc_imgbtn_anc_close_label, "");
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_close, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_close, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_close, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_close, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_close, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_close, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_CHECKED);
...
#else
	lv_imgbtn_set_src(ui->screen_anc_imgbtn_anc_open, LV_IMGBTN_STATE_RELEASED, NULL, "F:/ic_kai_lianjie.bin", NULL);
	lv_imgbtn_set_src(ui->screen_anc_imgbtn_anc_open, LV_IMGBTN_STATE_PRESSED, NULL, "F:/ic_kai_weilianjie.bin", NULL);
	lv_imgbtn_set_src(ui->screen_anc_imgbtn_anc_open, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "F:/ic_kai_xuanzhong.bin", NULL);
	lv_imgbtn_set_src(ui->screen_anc_imgbtn_anc_open, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "F:/ic_kai_lianjie.bin", NULL);
#endif
	ui->screen_anc_imgbtn_anc_open_label = lv_label_create(ui->screen_anc_imgbtn_anc_open);
	lv_label_set_text(ui->screen_anc_imgbtn_anc_open_label, "");
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_open, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_open, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_open, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_open, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_open, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_open, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_CHECKED);
...
#else
	lv_imgbtn_set_src(ui->screen_anc_imgbtn_anc_transparent, LV_IMGBTN_STATE_RELEASED, NULL, "F:/ic_tongtou_lianjie.bin", NULL);
	lv_imgbtn_set_src(ui->screen_anc_imgbtn_anc_transparent, LV_IMGBTN_STATE_PRESSED, NULL, "F:/ic_tongtou_weilianjie.bin", NULL);
	lv_imgbtn_set_src(ui->screen_anc_imgbtn_anc_transparent, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "F:/ic_tongtou_xuanzhong.bin", NULL);
	lv_imgbtn_set_src(ui->screen_anc_imgbtn_anc_transparent, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "F:/ic_tongtou_lianjie.bin", NULL);
#endif
	ui->screen_anc_imgbtn_anc_transparent_label = lv_label_create(ui->screen_anc_imgbtn_anc_transparent);
	lv_label_set_text(ui->screen_anc_imgbtn_anc_transparent_label, "");
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_transparent, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_transparent, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_transparent, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_transparent, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_anc_imgbtn_anc_transparent, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_anc_imgbtn_anc_transparent, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_label_set_long_mode(ui->screen_anc_label_anc_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_anc_label_anc_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
