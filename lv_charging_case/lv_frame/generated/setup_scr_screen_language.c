...
void setup_scr_screen_language(lv_ui *ui, lv_obj_t *page)
{
	...
	lv_obj_set_style_text_font(ui->screen_language_label_lang, &lv_font_pingfangheiti_bold_22, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_long_mode(ui->screen_language_label_lang_title, LV_LABEL_LONG_WRAP);
	...
	lv_obj_set_style_text_font(ui->screen_language_label_lang_title, &lv_font_pingfangheiti_bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
