...
static const u8 lcd_cmd_t_nv9307[] ALIGNED(4) = {
    ...
    _BEGIN_, 0xfe, _END_,
    _BEGIN_, 0xef, _END_,
    //_BEGIN_, 0x36, 0x68, _END_,  //横屏
    //_BEGIN_, 0x36, 0xe8, _END_, //竖屏  Y正向
    //_BEGIN_, 0x36, 0xA8, _END_, //竖屏  Y负向  
    _BEGIN_, 0x36, 0x58, _END_, //竖屏  Y负向  
    ...
    _BEGIN_, 0x11, REGFLAG_DELAY, _END_,
    _BEGIN_, 0x29, _END_,
    //_BEGIN_, 0x2c, _END_,
